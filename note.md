...
मेन थ्रेड: यह एक सिंगल प्रोसेस (Execution Thread) है जो आपके JavaScript कोड को असल में चलाता है (Execute करता है)। Node.js सिंगल-थ्रेडेड है, यानी कोड को प्रोसेस करने के लिए केवल एक ही मेन थ्रेड होता है।कॉल स्टैक: यह एक डेटा स्ट्रक्चर (मेमरी लोकेशन) है जो यह ट्रैक करता है कि इस समय थ्रेड के अंदर कौन से फंक्शन्स चल रहे हैं और किस फंक्शन के बाद कौन सा फंक्शन शुरू हुआ था।2. मुख्य काम (Primary Responsibility)मेन थ्रेड: इसका काम कोड की लाइनों को पढ़ना, कैलकुलेशन करना और वेरिएबल स्टोर करना है। यह पूरी मेहनत (CPU processing) करता है।कॉल स्टैक: इसका काम केवल मैनेजमेंट है। यह फंक्शन्स को LIFO (Last In, First Out) ऑर्डर में अरेंज करता है ताकि थ्रेड को पता रहे कि एक फंक्शन खत्म होने के बाद वापस कहाँ लौटना है।